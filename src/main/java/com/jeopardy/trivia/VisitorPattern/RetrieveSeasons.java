...
public class RetrieveSeasons implements TableElement {
    static DatabaseConnect db_conn;
    static com.jeopardy.trivia.Query query;

    public RetrieveSeasons(DatabaseConnect db_conn, com.jeopardy.trivia.Query query){
    ...
    @Override
    public void accept(DatabaseVisitor visitor) throws ParseException, IOException, SQLException {
        visitor.visit(this);
    }
}
